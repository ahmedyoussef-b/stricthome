...
async function main() {
  ...
  await prisma.task.createMany({
    data: [
      ...
      // Monthly
      { title: 'Objectif de sessions', description: 'Participez à au moins 3 sessions en direct ce mois-ci.', points: 100, type: TaskType.MONTHLY, category: TaskCategory.PERSONAL, duration: 30, isActive: true, prerequisites: [], difficulty: TaskDifficulty.MEDIUM },
